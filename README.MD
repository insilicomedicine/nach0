...
<p align="center">
  📃 <a href="https://arxiv.org/abs/2311.12410" target="_blank">Paper</a> • ⏬ <a href="insilicomedicine/nach0_base" target="_blank">Base nach0</a> • ⏬ <a href="insilicomedicine/nach0_base" target="_blank">Large nach0</a> <br>
</p>
...
To use model for the inference follow the steps.

1. Preprocess the input by replaceing the atom tokens with special tokens. 
...
3. Generate responce to prompt and replace special tokens with cooresponding atom tokens
  ```python
